  ...
  return (
    <>
      <div className='container-fluid' style={{backgroundColor:"black",height:"100vh"}}>
        <div className='row'>
          <div className='col-sm-6'style={{marginTop:"2.5rem"}}>
            <div className='card m-2' style={{backgroundColor:"rgba(90, 90, 90, 0.4)",color:"white",padding:"5px 30px",borderRadius:"20px"}}>
              ...
              <div className='card-footer'>
                <table className='table table-sm'>
                  <thead>
                    <tr style={{padding:"10px 0px",borderBottom:"transparent"}}>
                      <th style={{borderBottom:"transparent"}}>Title:</th>
                      <th style={{borderBottom:"transparent"}}>{data.title}</th>
                    </tr>
                    <tr>
                      <th>Price: </th>
                      <th style={{borderBottom:"2px solid #dee2e6"}}>₹ {data.price}</th>
                    </tr>
                    <tr>
                      <th>Description:</th>
